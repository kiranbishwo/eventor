                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <a href="addnewvendor" class=" btn btn-primary" >Add New Vendor</a>
                            </div>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="mb-0">Are you sure, you want to delete this Vendor!</p>
            </div>
...
$(document).ready(function(){
    ...
    e.preventDefault();
        ...
        success : function(data){
            ...
            if(data.status ==200){
                loadtable();
                Command: toastr["success"]("Success", "Vendor Deleted Sucessfully");
            }else{
